        ...
        <div class="login-page">
            ...
            <div class="left-panel">
                ...
                <div class="left-content">
                    ...
                    <p class="left-body">A refined digital space built for those who demand more from every interaction
                        and
                        every detail.</p>
                </div>
                        ...
                        <div class="form-group" id="emailGroup">
                            ...
                            <div class="form-input-wrap">
                                <input class="form-input" type="email" id="email" name="email"
                                    placeholder="you@example.com" autocomplete="email" value="{{ old('email') }}"
                                    required>
                        ...
                        <div class="form-group" id="passwordGroup">
                            ...
                            <div class="form-input-wrap">
                                ...
                                <button type="button" class="toggle-pw" id="togglePw"
                                    ...
                                    <!-- Eye-off icon -->
                                    <svg id="eyeOffIcon" width="17" height="17" viewBox="0 0 24 24"
