        ...
        <div class="products-page-inner">
            <div class="products-header">
                ...
                <div class="product-filter">
                    ...
                    <button type="button" class="filter-btn product-interactive" data-filter="trending">Trending</button>
                </div>
            </div>
                ...
                <div class="products-grid" id="productsGrid">
                    @foreach ($products as $product)
                        @php
                            ...
                            $mainImage = $firstVariant && ! empty($firstVariant->images[0])
                        ...
                        @if ($mainImage)
                            <article class="product-card product-interactive" data-tag="new trending sale">
                                <div class="product-img-wrap">
                                    <a href="{{ route('product', $product->id) }}" class="product-img-link product-interactive">
                                    ...
                                    <div class="product-actions">
                                        <button type="button" class="add-cart-btn product-interactive"
                                            onclick="event.preventDefault(); event.stopPropagation();">Add to Cart</button>
